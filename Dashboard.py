...
if page == "Welcome Page":
    ...
    * **Objective 8**: Understand the frequency of most used shipping method.
    ...
    - **1) Top Countries**: The countries with the highest import/export volumes i.e **Korea** in this analysis, are critical players and could offer strategic partnership opportunities. Focusing on these could enhance business reach and customer base.
    ...
    - **3) Product and Payment Terms Preferences**: The stacked bar chart illustrates that  popular payment terms across categories are as below and thus Offering incentives aacording to these payment methods, it might improve cash flow and reduce risk:
        ...
        **Clothing**:
        The most popular payment method is Cash on Delivery with 170 product counts.

        **Electronics**:
        The most popular payment method is Net 30 with 149 product counts.

        **Furniture**:
        The most popular payment method is Cash on Delivery with 173 product counts.

        **Machinery**:
        The most popular payment method is Cash on Delivery with 158 product counts.

        **Toys**:
        The most popular payment method is Cash on Delivery with 163 product counts.
    ...
    - **5) Average Value and Quantity of Top 5 Countries** : 
        **Honduras** leads in average quantity traded **(5,149.25 units)**, indicating a focus on high-volume transactions.
        **Honduras** again has the **highest average value (7,390.06)**, indicating that it trades in more quantity as well as higher-value products.
       ** Jordan, Ghana, and Guinea-Bissau** have relatively balanced profiles but show variations in the emphasis on either quantity or value.
                
    - **6) Top Product** : The most preferred product is **car**.
    ...
    Focus on High-Volume Countries: Prioritize countries like Korea for strategic partnerships to expand market reach.
    ...
    Prioritize Popular Products: Focus on products like "car" to meet customer demand.
     ...
     **3) Strategic Partnerships**
       - Focus on Top Countries: Explore potential partnerships with countries like "Korea" and "Congo" to expand market reach and access new customer segments.
     ...
     **6) Product Strategy**
       - Leverage Product Popularity: Focus on expanding the product range related to "car" to capitalize on its popularity.
